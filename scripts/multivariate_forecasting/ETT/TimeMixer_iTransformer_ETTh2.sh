...
python -u run.py \
  ...
  --data_path ETTh2.csv \
  --model_id ETTh2_96_96_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTh2 \
  --features M \
  --seq_len 96 \
...
python -u run.py \
  ...
  --root_path ../dataset/ETT-small/ \
  --data_path ETTh2.csv \
  --model_id ETTh2_96_192_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTh2 \
  --features M \
  --seq_len 96 \
...
python -u run.py \
  ...
  --root_path ../dataset/ETT-small/ \
  --data_path ETTh2.csv \
  --model_id ETTh2_96_336_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTh2 \
  --features M \
  --seq_len 96 \
...
python -u run.py \
  ...
  --root_path ../dataset/ETT-small/ \
  --data_path ETTh2.csv \
  --model_id ETTh2_96_720_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTh2 \
  --features M \
  --seq_len 96 \
