...
python -u run.py \
  ...
  --data_path ETTm1.csv \
  --model_id ETTm1_96_96_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTm1 \
  --features M \
  --seq_len 96 \
...
python -u run.py \
  ...
  --root_path ../dataset/ETT-small/ \
  --data_path ETTm1.csv \
  --model_id ETTm1_96_192_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTm1 \
  --features M \
  --seq_len 96 \
...
python -u run.py \
  ...
  --root_path ../dataset/ETT-small/ \
  --data_path ETTm1.csv \
  --model_id ETTm1_96_336_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTm1 \
  --features M \
  --seq_len 96 \
...
python -u run.py \
  ...
  --root_path ../dataset/ETT-small/ \
  --data_path ETTm1.csv \
  --model_id ETTm1_96_720_TimeMixer_iTransformer \
  --model $model_name \
  --data ETTm1 \
  --features M \
  --seq_len 96 \
